...
import { useGroup } from "../context/GroupContext"; // 👈 ADD THIS
...
export default function HomeScreen({ navigation }) {
  const { groupData } = useGroup(); // 👈 Get group info

  return (
    <ScrollView style={[styles.container, styles.scrollPadding]}>
      {/* Header Image */}
      {groupData?.mainImage ? (
        <Image source={{ uri: groupData.mainImage }} style={styles.headerImage} />
      ) : null}
