  ...
  return (
    <View style={styles.dataCard}>
      ...
      <View style={styles.section}>
        ...
        {renderDetail('Content', item.content ? item.content.substring(0, 100) + (item.content.length > 100 ? '...' : '') : 'N/A')}
      </View>
    </View>
  );
});
